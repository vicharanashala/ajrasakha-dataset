                ...
                <div className="flex flex-1 flex-col overflow-hidden">
                  <Table className="flex-1">
                    ...
                    <TableBody>
                      ...
                      {/* Blurred skeleton rows for unauthenticated users */}
                      {!isAuthenticated && Array.from({ length: 15 }, (_, i) => (
                        <TableRow
                          key={`blur-row-${i}`}
                          className="border-border/50"
                        >
                          <TableCell className="hidden py-3.5 pl-4 text-sm tabular-nums text-muted-foreground/30 sm:table-cell blur-sm select-none">
                            {5 + i + 1}
                          </TableCell>
                          <TableCell className="py-3.5">
                            <span className="block h-4 w-4/5 rounded-sm bg-muted-foreground/10 blur-sm" />
                            <span className="mt-1 block h-4 w-2/5 rounded-sm bg-muted-foreground/10 blur-sm" />
                          </TableCell>
                          <TableCell className="py-3.5">
                            <span className="inline-flex items-center rounded-full bg-muted px-2.5 py-0.5 text-xs font-medium text-muted-foreground blur-sm">
                              State
                            </span>
                          </TableCell>
                          <TableCell className="py-3.5 pr-4">
                            <span className="inline-flex items-center rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium text-primary blur-sm">
                              Crop
                            </span>
                          </TableCell>
                        </TableRow>
                  ...
                  {/* Sign-in prompt — sits above the blurred rows, always clickable */}
                  {!isAuthenticated && (
                    <div className="absolute inset-x-0 bottom-0 flex flex-col items-center gap-2 bg-gradient-to-t from-background/80 via-background/30 to-transparent py-6 pointer-events-none">
